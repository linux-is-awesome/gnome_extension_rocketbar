declare module 'gi://Cogl' {
    ...
    import type GObject from 'gi://Clutter';
    ...
    class Color {
        ...
        /**
         * Parses a string definition of a color, filling the Cogl.Color.red,
         * Cogl.Color.green, Cogl.Color.blue and Cogl.Color.alpha fields
         * 
         * @param colorString a string specifying a color
         */
        static from_string(colorString: string): [boolean, Color];
